<template>
    <!-- component -->
    <div class="min-h-screen flex flex-shrink-0 antialiased bg-gray-50 text-gray-800">
        <div class="flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
            <div class="flex items-center justify-start h-14 border-b">
                <h1 class="ml-4 font-bold">Simple Blogs</h1>
            </div>
